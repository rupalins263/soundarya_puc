                      ...
                      <div className="col-md-9 col-sm-9 col-lg-9">
                            <div id="myCarousel" className="carousel slide" data-ride="carousel">
                                ...
                                <div className="item active">
                                    <img src="http://res.cloudinary.com/dvl9i5pry/image/upload/v1506152816/lib-1_m5lupl.jpg" alt="Los Angeles" style={{"width":"100%"}}/>
                                </div>

                                <div className="item">
                                    <img src="http://res.cloudinary.com/dvl9i5pry/image/upload/v1506152834/lib-4_rynlxn.jpg" alt="Chicago" style={{"width":"100%"}}/>
                                </div>
                                
                                <div className="item">
                                    <img src="http://res.cloudinary.com/dvl9i5pry/image/upload/v1506152824/lib-2_gg91dr.jpg" alt="Chicago" style={{"width":"100%"}}/>
                                </div>
                                <div className="item">
                                    <img src="http://res.cloudinary.com/dvl9i5pry/image/upload/v1506152834/lib-4_rynlxn.jpg" alt="Chicago" style={{"width":"100%"}}/>
                                </div>
