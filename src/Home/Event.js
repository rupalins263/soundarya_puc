                        ...
                        <tbody>
                            <tr>
                                <td valign="top" style={{"border":"0px","width":"10px"}}>
                                    <section className="coll">Announcements:</section>
                                </td>
                                <td style={{"background-color":"#f6f6f6","border":"0px"}}>
                                    <section className="coll_inner">
                                        <marquee direction="scroll" srollamount="3" onmouseover="this.stop();" onmouseout="this.start();">
                                            <a href="#" style={{"text-decoration":"none","color":"#0070c0","font-weight":"bold"}}>
                                                Issue of Admission Ticket of II PUC Annual Examination on 24th March 2018.
                                            </a><b>&nbsp;&nbsp; || &nbsp;&nbsp;</b>
                                            <a href="#" style={{"text-decoration":"none","color":"#0070c0","font-weight":"bold"}}>
                                            ...
                                            <a href="http://zenopsys.net/soundarya_forms/puc/IIndpuc_finalexam18.pdf" style={{"text-decoration":"none","color":"#0070c0","font-weight":"bold"}}>
                ...
                <div className="col-md-5">
					...
					<div className="section-content">
						<div className="row">
                            ...
                            <div className="col-md-4">
                                <img  className="img-1" src="http://zenopsys.net/soundarya_forms/puc/puc1.jpg" alt="top-pu-college" style={{"height":"80px","padding-top":"3px"}}/>
                            </div>
                            <div className="col-md-4">
                                <img  className="img-1" src="http://zenopsys.net/soundarya_forms/puc/puc2.jpg" alt="top-pu-college"  style={{"height":"80px","padding-top":"3px"}}/>
                            </div>
                            <div className="col-md-4">
                                <img  className="img-1" src="http://zenopsys.net/soundarya_forms/puc/puc3.jpg" alt="top-pu-college"  style={{"height":"82px","width":"120px","padding-top":"3px"}}/>
                            </div>
							<br style={{"clear":"both"}}/>
							<br style={{"clear":"both"}}/>
